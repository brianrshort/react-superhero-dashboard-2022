...
import ironComics from "./seeds/phaseOne/IM1/hundoComics";
import hulkComics from "./seeds/phaseOne/Hulk/hundoComics";
import rhodeyComics from "./seeds/phaseOne/IM2/hundoComics";
...
class ComicTestTitles extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            comics: rhodeyComics,
    ...
    componentDidMount() {
            ...
            for (var i = 0; i < this.state.comics.length; i++) {
                ...
                axios.get(url).then(response => {
                    ...
                    this.setState({comicData: sortData});
    ...
    render() {
        ...
        let comicsMap = this.state.comicData.map(obj => {
...
export default ComicTestTitles;