...
function FlexComic() {
    ...
    useEffect(() => {
        if (topic === "strange") {
            setComicData(strangeComics[parseInt(id) - 1]);
        } else if (topic === "thor") {
            setComicData(thorComics[parseInt(id) - 1 ]);
        }

        let comic;
        if (topic === "strange") {
            comic = strangeComics[parseInt(id) - 1];
        } else if (topic === "thor") {
            comic = thorComics[parseInt(id) - 1 ];
        }
