//This file creates a wizard character! The rules for generating the 
//character are based on the Marvel Super Heroes Roleplaying Game
//from the 80s. Learn more at www.classicmarvelforever.com.


//The RANKS array allows users to random generate ability or power ranks.
//As with almost all arrays in this file, the array is an array of objects.
//The first property is RANGE, which gives two numbers to compare against 
//a randomly generated amount. This allows the ability/power rankings to be
//randomly generated, as they would be in an actual MSHRPG. 
...
//The ABILITIES array lists the abilities that all characters in the MSHRPG have. 
...
//The POWERRANGE array lists the number of powers that a character can have. 
...
//The POWERCATEGORIES array lists the categories for randomly generated powers. 
...
//The POWERSELECT array lists all of the individual powers (and their categories)
//from the Ultimate Powers Book from the 80s. Once a power category has been
//selected from the powerCategories array, a new randomly generated number can
//be compared to the individual objects to generate a specific power.
...
//The makeARoll function randomly generates a number between 1-100. 
...
//The checkForEach function takes a randomly generated number and checks a given array
//for a property associated with that number. This is to generate powers and 
//power ranks and ability ranks randomly, simulating the d100 tables of MSHRPG.
...
//The makePower function randomly generates a number of powers, then finds
//power categories and indivudal power names based on randomly generated rolls. 
...
function makePower() {
    ...
    //const filtered = getUniqueItemsByProperties(powerSet, power);
...
//The makeWizard function generates random ability ranks and power sets 
//(including power names and power rankings) to randomly generate an MSHRPG-style
//wizard character. 
